...
/// <summary>
/// 우클릭 차징공격 A
/// - HammerSwingController를 사용하여 망치 공격 실행
/// - 그로기 적 처형 가능
/// </summary>
[CreateAssetMenu(fileName = "SecondaryChargedAttackA", menuName = "Combat/Secondary Charged Attack A")]
public class SecondaryChargedAttackA : ScriptableObject, ISecondaryChargedAttack
{
