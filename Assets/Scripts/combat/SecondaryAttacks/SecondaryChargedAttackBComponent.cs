...
/// <summary>
/// 우클릭 차징공격 B (MonoBehaviour 버전)
/// - 기존 SO 기반 SecondaryChargedAttackB와 동일한 동작을 컴포넌트로 제공
/// </summary>
[DisallowMultipleComponent]
[AddComponentMenu("Combat/Secondary Charged Attack B (Mono)")]
public class SecondaryChargedAttackBComponent : MonoBehaviour, ISecondaryChargedAttack
{
    ...
    public string GetAttackName() => "차징공격 B (컴포넌트)";
